...
# -*- coding: utf-8 -*-
#
# hw5_helpers_pkg documentation build configuration file, created by
...
modindex_common_prefix = ["hw5_helpers_pkg"]
...
basename = "hw5_helpers_pkg".replace(" ", "").replace(".", "")
